            ...
            render: (text) => (
                <div className="campaign-name-cell">
                    <div style={{ position: 'relative', display: 'flex', alignItems: "center" }} className="campaign-name">
                        {text === "active" ? <div style={{ width: '8px', marginRight: "5px", height: '8px', borderRadius: '50%', backgroundColor: '#66be0f' }}></div> : text === "Campaign off" ?
                            <div>
                                <div style={{ width: "15px", height: '15px', borderRadius: '50%', backgroundColor: 'red' }}>d</div>
                            </div> : null}<div style={{ fontSize: '14px' }}>{text}</div>
                    </div>
